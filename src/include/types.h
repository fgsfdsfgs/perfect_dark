...
struct textoverride {
	...
	/*0x04*/ s32 objoffset;
	/*0x08*/ s32 weapon;
	/*0x0c*/ char *obtaintext;     // eg. "Obtain medlab 2 keycard\n"
	/*0x10*/ char *ownertext;      // eg. "Guard's\n"
	/*0x14*/ char *inventorytext;  // eg. "Medlab 2 key card\n"
	/*0x18*/ char *inventory2text; // eg. "Medlab 2 key card\n"
